...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
H2_1 = homographie(XY_C2,XY_C1);
Imos2_1 = mosaiquecoul_sens(Im2_coul,Im1_coul,H2_1,"Inverse");
[XY_21,Res_21] = harris(rgb2gray(uint8(Imos2_1)),TailleFenetre,NbPoints,k);

[XY_3,Res_3] = harris(Im3,TailleFenetre,NbPoints,k);
[XY_C2,XY_C3] = apparier_POI(Im2,XY_2,Im3,XY_3,TailleFenetre,seuil);
H2_3 = homographie(XY_C2,XY_C3);
Imos2_3 = mosaiquecoul_sens(Im2_coul,Im3_coul,H2_3,"Direct");
[XY_23,Res_23] = harris(rgb2gray(uint8(Imos2_3)),TailleFenetre,NbPoints,k);

[XY_C21,XY_C23] = apparier_POI(rgb2gray(uint8(Imos2_1)),XY_21,rgb2gray(uint8(Imos2_3)),XY_23,TailleFenetre,0.97);
H21_23 = homographie(XY_C21,XY_C23);
I_mos123 = mosaiquecoul_sens(uint8(Imos2_1),uint8(Imos2_3),H21_23,"Direct");
figure;
