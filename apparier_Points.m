...
%% A COMPLETER %%
%%%%%%%%%%%%%%%%%
var_I1 = var(vois1, 0, 2);
var_I2 = var(vois2, 0, 2);
% Pour chaque combinaison de paires de points, la covariance 
% entre les deux voisinages : le numerateur dans la formule ZNCC
%%%%%%%%%%%%%%%%%
%% A COMPLETER %%
%%%%%%%%%%%%%%%%%
num = sum((vois1(indptI1(i1),:) - moy_I1(indptI1(i1))) .* (vois2(indptI2(i2),:) - moy_I2(indptI2(i2))),2);
...
%% A COMPLETER %%
%%%%%%%%%%%%%%%%%
denom = sqrt(var_I1(indptI1(i1)) .* var_I2(indptI2(i2)));
cor = num./denom;
